...
const CanvasParticleEffect = (props) => {
    /**
    ...
    function init() {
        canvas = document.getElementById('particleEffect');
    ...
    function initParticle(p) {
        ...
        p.color.h =
            hueBase +
            (Math.atan2(centerY - p.y, centerX - p.x) * 180) / Math.PI;
        p.color.s = 1;
        p.color.l = 0.5;
        p.color.a = 0;
    }
    ...
    return <canvas id="particleEffect" className="h-screen w-screen"></canvas>;
};
